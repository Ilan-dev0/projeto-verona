    ...
    return (
      <div className=' h-[120px] w-full m-0-auto'>
        ...
        <div style={{backgroundImage: `url(${background})`}} className='m-0 h-[205px] w-full bg-center bg-cover duration-500 absolute'>
          ...
          <h1 className='text-white text-center text-3xl text-bold absolute left-10 top-28 sm:top-28 sm:left-40 sm:text-4xl'>MANUTENÇÃO DE PORTAS DE AÇO AUTOMÁTICAS</h1>
         </div>
        </div>
      </div>
    )
