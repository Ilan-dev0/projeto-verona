    ...
    <div className=' h-full w-full'>
        <div className='p-20 w-full h-full bg-zinc-900 justify-center'>
            <div className='p-10 space-y-10'>
                <p className='text-white text-justify sm:text-start font-light text-lg tracking-wider'>Localizada na região norte de São Paulo, conquistou a confiança dos clientes por utilizar em suas fabricações as melhores matérias primas do mercado, maquinário de última geração e tendo à disposição uma equipe especializada em soluções comerciais, industriais e residenciais.</p>
                <p className='text-white text-justify sm:text-start font-light text-lg tracking-wider'>Um de nossos grandes diferenciais é ter uma rigorosa política de qualidade que oferece treinamentos de capacitação e segurança ao time técnico a cada três meses. Assim, seguimos atualizados quanto às novidades do mercado e sempre à frente dos nossos concorrentes.</p>
                <p className='text-white text-justify sm:text-start font-light text-lg tracking-wider'>
A Verona Portas de Aço conta com uma infraestrutura completa para atender os clientes em São Paulo e nos estados da região Sul e Sudeste. Aqui você irá comprar com uma empresa consolidada e validada no mercado, que passa a anos por consecutivas evoluções técnicas e aprimoramentos. Obra é coisa séria e a Verona é especialista. </p>
                <p className='text-white text-justify sm:text-start font-light text-lg tracking-wider'>Tudo o que você precisa para garantir a máxima proteção no seu projeto.</p>
                <p className='text-white text-justify sm:text-start font-light text-lg tracking-wider'>Para mais informações sobre os produtos, serviços ou para fazer uma cotação sem compromisso, clique no botão abaixo e fale agora mesmo com a nossa equipe!</p>
            
            </div>
            <div className='p-10  grid md:grid-cols-2  m-auto  text-center justify-between items-center'>
