...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className={`w-full bg-zinc-900 fixed top-0 left-0 right-0 z-10  p-3 ${ nav ? 'overflow-scroll h-[100%]' : 'block'}`}   >
          ...
          <div>
            ...
            >
              <ul className="h-screen md:h-auto items-center justify-center md:flex ">
                ...
                <li className="relative pb-6 text-xl text-white py-2 px-6 md:py-8 text-center  border-b-2 md:border-b-0   hover:text-red-900 hover:bg-white group">
