...
const Navbar = () => {
  ...
  return (
    <div className='w-screen h-[190px] z-10 bg-zinc-900 fixed drop-shadlow-lg '>
        <div className='p-5 flex justify-center items-center w-full h-full'>
            <div className='flex items-center border-b-2 p-4'>
                <img className='h-20 sm:w-33 cursor-pointer mr-4 ' src={logoimg} alt='logo' />
        ...
        <ul className={!nav ? 'hidden' : 'absolute bg-zinc-900 w-full  px-10'}>
                    ...
                    <li className='border-b-2 border-white w-full mb-10'>
                        <a href='/manutencao'>MANUTENÇÃO</a>
                    </li>
        </ul>
