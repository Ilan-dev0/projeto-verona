      ...
      <div className='w-full h-max-[940px] h-full bg-zinc-900'>
          ...
          <div className='grid md:grid-cols-3 max-w-[1000px] m-auto  p-5 md:space-x-20'>
            <div className='py-5 text-center items-center justify-between flex flex-col '>
              ...
              <a href='/Comercial'><motion.button 
              initial={{ scale: 1.0 }}
              animate={{ scale: [1.0, 1.2, 1.0]  }}
              transition={{ duration: 2, repeat: Infinity }}
              whileTap={{ scale: 0.9 }}
              className='rounded-none px-20 py-2 mt-4 text-white bg-transparent hover:bg-red-800 hover:border-red-800 hover:text-white border-white'>DETALHES</motion.button></a>
            </div>
            ...
            <div className='py-5 text-center items-center justify-between flex flex-col ml-2'>
              ...
              <a href='/Residencial'><motion.button 
              initial={{ scale: 1.0 }}
              animate={{ scale: [1.0, 1.2, 1.0]  }}
              transition={{ duration: 2, repeat: Infinity }}
              whileTap={{ scale: 0.9 }}
            ...
            <div className='py-5 text-center items-center justify-between flex flex-col ml-2'>
              ...
              <a href='/Industrial'><motion.button
              initial={{ scale: 1.0 }}
              animate={{ scale: [1.0, 1.2, 1.0]  }}
              transition={{ duration: 2, repeat: Infinity }}
              whileTap={{ scale: 0.9 }} 
