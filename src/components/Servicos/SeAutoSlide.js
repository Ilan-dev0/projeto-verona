  ...
  return (
    <div className='mt-44 w-full m-0-auto min-w-[100vh]  flex-column  align-center justify-center bg-zinc-900'>
        <div className='w-full m-0-auto min-w-[100vh] flex  align-center justify-center bg-zinc-900 pt-10'>
            ...
            <p className='text-white text-start font-thin'>A aplicação das portas de aço automáticas de enrolar está voltada para as Indústrias, Comércios, Centros Logísticos, Hangares, Shoppings Center, e agora também para Residências, em novos projetos que a utilizam inclusive em ambientes internos, suprindo todo o segmento com uma solução simples e eficaz nos quesitos espaço, ergonomia e, principalmente, manutenção.</p>
            <p className='text-white text-start mt-10 font-thin'>Grandes clientes fazem parte de nossa história, atestando a qualidade que a nossa empresa oferece ao mercado nacional quando o assunto é a instalação de portas de aço automáticas.s</p>
            </div>
    </div>
  )
}
